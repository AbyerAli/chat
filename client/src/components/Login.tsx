					...
					<div className='p-4 sm:p-7'>
						<div className='text-center'>
							...
							<p className='mt-2 text-sm text-gray-600 dark:text-neutral-400'>
								...
								<a
									className='font-medium text-blue-600 decoration-2 hover:underline dark:text-blue-500 cursor-pointer' onClick={() => setSignup(false)}
								>
									Sign in here
								</a>
							</p>
				...
				<div className='p-4 sm:p-7'>
					<div className='text-center'>
						...
						<p className='mt-2 text-sm text-gray-600 dark:text-neutral-400'>
							...
							<a
								className='font-medium text-blue-600 decoration-2 hover:underline dark:text-blue-500 cursor-pointer' onClick={() => setSignup(true)}
